...
def generate_launch_description():
    ...
    imu_bridge = Node(
        ...
        name='imu_bridge',
        arguments=[
            '/world/warehouse/model/turtlebot4/link/imu_link/sensor/imu/imu@sensor_msgs/msg/Imu[ignition.msgs.IMU'
        ],
        remappings=[
            ('/world/warehouse/model/turtlebot4/link/imu_link/sensor/imu/imu', '/imu/data')
        ],
        output='screen'
    )
